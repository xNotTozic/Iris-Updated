...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledCustomRadius(const ImVec2& p_min, const ImVec2& p_max, ImU32 col, float topLeftRadius, float topRightRadius, float bottomLeftRadius, float bottomRightRadius);
    ...
    IMGUI_API void AddCleanShadowRect(const ImVec2& obj_min, const ImVec2& obj_max, ImU32 shadow_col, float shadow_size);
